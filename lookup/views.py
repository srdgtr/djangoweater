...
def home(request):
    ...
    if request.method == "POST":
        ...
        # print (zipcode)
        api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=25&API_KEY=5565C821-F00F-45A6-B47E-64D1C2A14FDC")
        ...
        api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=20002&distance=5&API_KEY=5565C821-F00F-45A6-B47E-64D1C2A14FDC")
